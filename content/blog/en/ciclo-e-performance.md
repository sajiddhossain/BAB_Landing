...
faq:
  ...
  - q: "How many girls avoid sport when they have their period?"
  ...
  - q: "Does menarche change participation in sport?"
    a: "Less than commonly assumed, and not equally across sports. A longitudinal study of 6,639 Australian adolescents found that menarche was associated with lower odds of playing individual sports (OR 0.74), but with no significant effect on team sports or on overall moderate-to-vigorous physical activity (Gopalan et al., 2025). That matters because it deflates a cliché: a first period does not, by itself, switch an athlete off. What does is a cycle experienced in an environment that never mentions it — and if puberty arrives earlier than average, the risk of dropping out rises measurably (HR 1.68; Gallant et al., 2023)."
  - q: "Does the menstrual cycle increase injury risk?"
  ...
  - q: "Is it better to skip training during your period?"
    a: "In most cases it is not necessary to skip it entirely: the useful distinction is between discomfort and pain that genuinely limits. Among athletes, dysmenorrhoea is the most frequent menstrual disorder, with a prevalence of 32.3% and a very wide range across studies, 7.8-85.6% (Taim et al., 2023). Exercise is among the treatments with a measured effect on period pain: a large reduction in intensity compared with doing nothing (SMD -1.86; 95% CI -2.06 to -1.66), at a dose of 45-60 minutes at least 3 times a week — but with LOW-quality evidence and a population of women rather than adolescents (Armour et al., 2019). Pain that makes a girl miss school and training every month should be taken to a healthcare professional, not endured."
  - q: "How much does cycle phase actually affect performance, in practice?"
    a: "Far less than sleep, energy and accumulated training do. In the largest available meta-analysis — 78 studies, 1,193 participants — the effect of cycle phase on performance is of «trivial» magnitude, with a reduction in the early follicular phase (ES 0.5 = -0.06; 95% CrI -0.16 to 0.04) and evidence quality rated low under GRADE (McNulty et al., 2020). Population: ADULT women aged 18-40. For comparison, resistance training in children and adolescents produces strength gains with an overall effect size of 1.12 (95% CI 0.9-1.3) (Behringer et al., 2010): a different order of magnitude. The practical consequence is that building good months is worth more than chasing the right day of the month."
...
> - Tracking your own signals over time helps you recognise them: **monitoring is not diagnosing**.

## Does the cycle affect performance? What the data actually says

Yes — according to the large majority of athletes who live it. In a longitudinal study of **128 elite athletes** in British Athletics' world-class programme, **77% reported their performance had been negatively affected by their cycle** at some point during the study period (Jones et al., 2024).
...
## Should you skip training during your period?

**It is almost never necessary to skip it entirely, but pain should be treated rather than endured.** The useful distinction is between discomfort and pain that limits: among athletes, dysmenorrhoea is the most frequent menstrual disorder, with a prevalence of 32.3% (range across studies 7.8-85.6%; Taim et al., 2023), and exercise itself is among the treatments with a measured effect — a large reduction in pain intensity compared with doing nothing (SMD -1.86; 95% CI -2.06 to -1.66), albeit with low-quality evidence (Armour et al., 2019). A girl who hurts every month to the point of missing school and training does not need more discipline: she needs someone to look at the pain. The topic is covered in full in [period pain and dysmenorrhoea](/blog/dolori-mestruali-giovani-atlete).

One thing usually missing from this conversation is worth adding: part of what gets attributed to the cycle is better explained elsewhere. [Iron deficiency](/blog/ferro-atlete-adolescenti) affects 53% of adolescent female athletes in its mild form (Nicotra et al., 2023) and produces exactly the symptoms that tend to get filed under «a bad week»; and [sleep](/blog/sonno-atlete-adolescenti) changes on its own in adolescence, independently of the cycle. Tracking signals serves this purpose too: not attributing everything to a single cause.
...
BAB helps athletes recognise these signals privately, and gives coaches and clubs **only aggregated, anonymous signals** — never the cycle or individual health. Cycle phase, where shown, is an estimate and not a clinical value: we observe and flag, we don't diagnose. Because understanding your body should never cost you your privacy.

## Sources

- Jones B.P., L'Heveder A., Bishop C., et al. **Menstrual cycles and the impact upon performance in elite British track and field athletes: a longitudinal study.** *Frontiers in Sports and Active Living*, 2024;6:1296189. (n=128 elite athletes, mean age 28) [doi:10.3389/fspor.2024.1296189](https://doi.org/10.3389/fspor.2024.1296189)
...
- Herzberg S.D., Motu'apuaka M.L., Lambert W., Fu R., Brady J., Guise J.M. **The Effect of Menstrual Cycle and Contraceptives on ACL Injuries and Laxity: A Systematic Review and Meta-analysis.** *Orthopaedic Journal of Sports Medicine*, 2017;5(7):2325967117718781. (21 studies, 68,758 participants; overall quality of evidence rated 'very low' under GRADE) [doi:10.1177/2325967117718781](https://doi.org/10.1177/2325967117718781)
...
- Armour M., Ee C.C., Naidoo D., Ayati Z., Chalmers K.J., Steel K.A., de Manincor M.J., Delshad E. **Exercise for dysmenorrhoea.** *Cochrane Database of Systematic Reviews*, 2019;9:CD004142. (12 studies and 854 women, 10 studies and 754 women in meta-analysis; SMD -1.86, 95% CI -2.06 to -1.66 versus no treatment, roughly 25 mm on a 100 mm visual analogue scale; dose 45-60 minutes at least 3 times a week; LOW-quality evidence; population of women, not adolescents) [doi:10.1002/14651858.CD004142.pub4](https://doi.org/10.1002/14651858.CD004142.pub4)
- Nicotra D., Arieli R., Redlich Amirav D., Ish-Shalom M., Constantini N.W. **Iron Deficiency and Anemia in Male and Female Adolescent Athletes Who Engage in Ball Games.** *Journal of Clinical Medicine*, 2023;12(3):970. (adolescent athletes aged 11-18; prevalence of mild iron deficiency, ferritin ≤30 µg/L, of 53.2% in girls; iron-deficiency anaemia in 4%) [doi:10.3390/jcm12030970](https://doi.org/10.3390/jcm12030970)
