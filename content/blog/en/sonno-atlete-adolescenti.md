...
faq:
  ...
  - q: "How many hours should an adolescent athlete sleep?"
    a: "The consensus recommendation for the 13-18 band is 8-10 hours per night (Paruthi et al., 2016). It is a general-health threshold rather than a sporting one, and it matters all the more for those who train: in adolescent athletes, sleeping less than 8 hours is associated with being injured 1.7 times as often (95% CI 1.0-3.0; p=0.04) — a borderline-significant finding, in a mixed sample of 112 athletes and not broken down by sex, so an association rather than a demonstrated cause (Milewski et al., 2014). The practical point stands anyway: sleep hours are, alongside load, one of the few variables a family can genuinely govern."
  - q: "Why can’t an adolescent fall asleep early even when she tries?"
    a: "Because with puberty the biological clock shifts later: the need for sleep does not decrease, what changes is the hour at which the body can fall asleep (Carskadon, 2011). It is a physiological explanation, not a character one, and it has an uncomfortable consequence: if sleep onset comes later while the alarm stays on school time, the missing hours are not recovered within the week. In girls the picture is further complicated across development: insomnia symptoms rise from 3.4% to 12.2% between Tanner stage 1 and stage 5, against 4.3%-9.1% in boys (Zhang et al., 2016)."
  - q: "Does sleeping more mean winning more?"
    a: "Not in the terms the question is usually asked, and it is worth being honest about that. The studies showing performance improvements with sleep extension are largely conducted on ADULTS, often male, in sporting contexts far removed from a fourteen-year-old’s: presenting them as valid at 14 is a leap the data does not license. What holds in the adolescent band is more cautious and more useful: the 8-10 hour recommendation (Paruthi et al., 2016) and the association between insufficient sleep and injury (Milewski et al., 2014). Sleep is not a performance supplement: it is a condition of growing."
  - q: "Does sleeping in on Saturday make up for the hours lost during the week?"
    a: "Partly, and with a side effect that usually goes unnoticed. The debt built up over five short nights is not cleared by one long morning, and above all Saturday's recovery pushes the time the body can fall asleep on Sunday night even later: in puberty the circadian phase is already delayed, and it is the conflict between that delay and the fixed school alarm that produces the debt in the first place (Carskadon, 2011). The more effective lever is therefore not sleeping more at the weekend: it is keeping wake-up time as stable as possible on Saturday and Sunday too, and acting on when midweek training ends. The reference remains 8-10 hours per night between 13 and 18 (Paruthi et al., 2016)."
  - q: "How can I tell whether my daughter is getting enough sleep?"
    a: "By looking at weekly patterns rather than at a single night, and by using two concrete reference points. The first is quantitative: the American Academy of Sleep Medicine consensus recommendation for ages 13-18 is 8-10 hours per night, athletes included (Paruthi et al., 2016). The second is functional: if a girl needs several alarms, if she sleeps several hours longer on Saturday than usual, and if tiredness recurs in the same weeks — for instance the ones with three evening sessions — the problem is not the single night, it is the structure of the week. Do not turn this into a home test: if difficulty falling asleep or unrefreshing sleep lasts for weeks, it belongs with a paediatrician. Chronically disturbed sleep is not a personality trait."
...
- Paruthi S., Brooks L.J., D'Ambrosio C., Hall W.A., Kotagal S., Lloyd R.M., Malow B.A., Maski K., Nichols C., Quan S.F., Rosen C.L., Troester M.M., Wise M.S. **Recommended Amount of Sleep for Pediatric Populations: A Consensus Statement of the American Academy of Sleep Medicine.** *Journal of Clinical Sleep Medicine*, 2016;12(6):785-786. (consensus recommendation; ages 13-18: 8-10 hours) [doi:10.5664/jcsm.5866](https://doi.org/10.5664/jcsm.5866)
- Milewski M.D., Skaggs D.L., Bishop G.A., Pace J.L., Ibrahim D.A., Wren T.A.L., Barzdukas A. **Chronic lack of sleep is associated with increased sports injuries in adolescent athletes.** *Journal of Pediatric Orthopaedics*, 2014;34(2):129-133. (n=112 adolescent athletes, 54 male and 58 female; cross-sectional, results not broken down by sex) [doi:10.1097/BPO.0000000000000151](https://doi.org/10.1097/BPO.0000000000000151)
- Zhang J., Chan N.Y., Lam S.P., Li S.X., Liu Y., Chan J.W., Kong A.P., Ma R.C., Chan K.C., Li A.M., Wing Y.K. **Emergence of Sex Differences in Insomnia Symptoms in Adolescents: A Large-Scale School-Based Study.** *Sleep*, 2016;39(8):1563-1570. (n=7,507, aged 6-17, 48.5% female) [doi:10.5665/sleep.6022](https://doi.org/10.5665/sleep.6022)
- Carskadon M.A. **Sleep in Adolescents: The Perfect Storm.** *Pediatric Clinics of North America*, 2011;58(3):637-647. (review of adolescent sleep biology) [doi:10.1016/j.pcl.2011.03.003](https://doi.org/10.1016/j.pcl.2011.03.003)
- Watson A.M. **Sleep and Athletic Performance.** *Current Sports Medicine Reports*, 2017;16(6):413-418. (narrative review, athletes in general, not adolescent-specific) [doi:10.1249/JSR.0000000000000418](https://doi.org/10.1249/JSR.0000000000000418)
- Mah C.D., Mah K.E., Kezirian E.J., Dement W.C. **The effects of sleep extension on the athletic performance of collegiate basketball players.** *Sleep*, 2011;34(7):943-950. (n=11 **adult male** collegiate basketball players, mean age 19.4, no control group — not transferable to teenage female athletes) [doi:10.5665/SLEEP.1132](https://doi.org/10.5665/SLEEP.1132)
