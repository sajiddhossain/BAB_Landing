...
faq:
  ...
  - q: "What should you say to an athlete who mentions period pain?"
    a: "A few words, and no clinical questions: \"okay, let's adapt today's session — you tell me what you feel up to\". No details, no dates, no diagnosis. Period pain is anything but rare among athletes — it is the most frequent menstrual cycle disorder, with an estimated prevalence of 32.3% across 60 studies and 6,380 athletes (Taim et al., 2023) — and the available evidence places exercise among the studied treatments, not among the risk factors (Armour et al., 2019, Cochrane review, low quality evidence). So neither \"rest until it passes\" nor \"grit your teeth\": the choice is the athlete's, the practical conditions are the staff's responsibility."
...
Silence, in other words, is **a channel problem**, not a willingness problem. And it has a measurable cost: among adolescents aged 10-18, between **25.2% and 61.1%** avoid or reduce physical activity during their period, often out of fear of leaks and embarrassment rather than pain ([Harvey et al., 2025, *BMC Women's Health*](https://doi.org/10.1186/s12905-025-03825-w)). Those are lost training sessions nobody records — a mechanism we covered in detail in [the cycle and performance](/en/blog/ciclo-e-performance). And when the reason is pain, there is something concrete to offer instead of silence: [what actually works for period pain](/en/blog/dolori-mestruali-giovani-atlete), and the threshold beyond which pain should be assessed by a doctor. And periods are not the only topic that stays outside the changing room: [urinary leakage during sport](/en/blog/perdite-urina-giovani-atlete) follows exactly the same curve of silence. On the material side, though, the answer is organisational: [products, uniforms and what to keep at the gym](/en/blog/gestire-ciclo-nello-sport) are the part of the problem a club can solve without a single difficult conversation.
...
- **The family**: be the first safe channel, without turning every question into an interrogation.
- **The athlete**: observe your own patterns. Recognising them is already half the path to being able to talk about them — with whoever you choose, whenever you choose.

## BAB's role

BAB was born exactly in this void. It gives the athlete a **private space** to recognise her own signals, an **educational layer** that fills the 88% "learned on my own", and clubs **only aggregated, anonymous signals** — never an individual's cycle or health. It opens the channel that doesn't exist today, without forcing anyone into a conversation she doesn't want. Because breaking the silence doesn't mean forcing people to speak: it means finally **making it easy** to.
...
- Armour M., Ee C.C., Naidoo D., et al. **Exercise for dysmenorrhoea.** *Cochrane Database of Systematic Reviews*, 2019;9:CD004142. (12 studies, 854 women; SMD -1.86, 95% CI -2.06 to -1.66; **low quality evidence**) [doi:10.1002/14651858.CD004142.pub4](https://doi.org/10.1002/14651858.CD004142.pub4)
