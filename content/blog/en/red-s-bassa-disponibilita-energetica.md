...
faq:
  ...
  - q: "Is losing your period because you train hard normal?"
  ...
  - q: "Does RED-S only affect girls?"
    a: "No. It grew out of a picture first described in female athletes — the Female Athlete Triad (De Souza et al., 2014) — but the International Olympic Committee consensus that introduced RED-S in 2014 and updated it in 2023 defines it as a syndrome affecting all sexes, touching the immune system, metabolism, mood, the cardiovascular system, bone health and performance itself (Mountjoy et al., 2014; Mountjoy et al., 2023). In female athletes the most visible warning sign — a period that thins out or disappears — simply does not exist in male athletes, which makes recognition later rather than the problem absent."
  - q: "Why is there so little data on RED-S in adolescent athletes?"
...
- **LEAF-Q** — a validated screening questionnaire covering gastrointestinal symptoms, menstrual function and injuries ([Melin et al., 2014](https://doi.org/10.1136/bjsports-2013-093240)).
