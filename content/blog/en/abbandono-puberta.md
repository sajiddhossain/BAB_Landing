...
faq:
  ...
  - q: "What part do the symptoms nobody talks about play?"
    a: "They are the part of the phenomenon nobody counts, because it leaves no record. Between 25.2% and 61.1% of adolescent girls avoid or reduce physical activity during menstruation — for pain, but also for fear of visible leaks (Harvey et al., 2025). At 13-14, 51% of girls say their breasts affect their participation in sport, yet only 10% always wear a sports bra (Scurr et al., 2016). And among adolescent female athletes the mean prevalence of urinary incontinence during sport is 48.58%, while 87% say they would not mention it to their coach (Rial Rebullido et al., 2021). These are withdrawals nobody records as injuries, yet they remove training sessions exactly like injuries."
  - q: "At what age are most girls lost to sport?"
    a: "In the 10-14 window — exactly the puberty window. Following seven years of actual club registrations for 29,225 Australian female athletes, among those who joined aged 10-14 only 13% participated consistently and 71% dropped out without ever returning (Eime et al., 2020). That it is the changing body, rather than the calendar, that moves the needle is suggested by a longitudinal study of 781 Canadian adolescents: girls with early puberty were significantly more likely to discontinue organised activities than peers developing on an average timeline (HR 1.68; 95% CI 1.05-2.69) (Gallant et al., 2023)."
  ...
  - q: "Is drop-out higher among girls than among boys?"
    a: "In the available data yes, but the two main sources measure different things and should not be conflated. On perception, a nationally representative UK survey of 2,291 girls and 2,024 boys aged 11-18 found 43% of girls in the group who «used to love sport» and disengaged, against 24% of boys (Women in Sport, 2022 — not peer-reviewed, i.e. grey literature). On actual registrations, the Australian study of 29,225 female athletes reports 71% dropping out without returning among those joining aged 10-14, but it follows female athletes only: it offers no direct comparison with boys (Eime et al., 2020). The gap is documented on perceptions; on registrations the comparison is simply missing."
  - q: "Which years should a club focus on to avoid losing its athletes?"
    a: "The 10-14 window, for a specific reason: that is where both most of the drop-out and the bodily changes that accompany it are concentrated. In the Australian data on 29,225 athletes, among those joining aged 10-14 only 13% take part continuously over the following seven years (Eime et al., 2020). The same interval contains peak height velocity, whose estimated mean age in young female athletes is 11.18 years with a 90% credible interval from 8.62 to 12.94 years (Lima et al., 2024). Acting at 16 means acting on the girls who already stayed."
  - q: "What do injuries have to do with girls dropping out of sport?"
    a: "A drop-out often begins with one long lay-off, and long lay-offs are not randomly distributed. In high-school sport, girls sustain 1.40 times the ACL injuries of male peers (Bram et al., 2021) and stress fractures 1.75 times as often, with one in five recurring (Changstrom et al., 2015). The good news is that this is the most governable lever: twenty minutes of neuromuscular training twice a week cuts ACL injury risk by roughly 60% in athletes aged 13-19 (Petushek et al., 2019). Careful not to read these numbers as an individual prediction: they are population rates."
  - q: "What does NOT work for keeping girls in sport?"
    a: "Anything that treats drop-out as an individual motivation problem. The data indicate the phenomenon follows the body and the environment, not willpower: earlier puberty significantly raises the probability of discontinuing organised activity (HR 1.68; 95% CI 1.05-2.69) (Gallant et al., 2023), and between 25.2% and 61.1% of adolescent girls avoid or reduce physical activity during their period, partly for fear of leaking and embarrassment (Harvey et al., 2025). Motivational talks, demands for «more commitment» and attendance league tables touch neither of those causes — and in the case of comments about bodies they can make things worse."
---
...
> - **Earlier puberty** significantly raises the likelihood of dropping out (HR 1.68; Gallant et al., 2023).

## How many girls really leave sport?

It's worth being precise here, because inflated numbers circulate on this topic — including ours, in an earlier version of this article.

The most-cited figure is British: in a nationally representative survey of **2,291 girls aged 11-18**, **43%** fall into the segment who *"used to love sport"* and disengaged after primary school, against **24%** of boys the same age (Women in Sport, 2022). The report is grey literature — not peer-reviewed — and it measures a **shift in self-perception**, not verified drop-out: the girls say they no longer think of themselves as sporty. That's an important signal, but it isn't the same as quitting.

For the real number, look at registrations. Tracking the actual club sign-ups of **29,225 female athletes** over seven years, among those who joined aged **10-14** only **13%** participated continuously, while **71% dropped out and never returned** (Eime et al., 2020). This is peer-reviewed work on administrative data rather than perceptions — and the picture it gives is no more reassuring.
...
There is also a part of this story that belongs to the fast-growing body: in the years around [the growth spurt](/en/blog/picco-di-crescita-giovani-atlete) movements can feel less precise, and an athlete who believes she has "got clumsy" has one more reason to step aside. It should be said that the evidence on that phase, in girls, is still limited — all the more reason not to turn it into a verdict.

There is also an exit route that does not run through the body and gets noticed even later, because it produces no visible symptom: athlete burnout — exhaustion, a falling sense of accomplishment and, in the end, a sport that stops mattering. The American Academy of Pediatrics clinical report names it as one of the primary reasons for attrition in youth sports (Brenner et al., 2024), and among 980 adolescent athletes 1-9% showed elevated scores (Gustafsson et al., 2007): we have written about it, together with [performance anxiety, in a dedicated article](/en/blog/ansia-prestazione-burnout-giovani-atlete).
...
When an environment won't talk about periods, energy and a changing body, the athlete is left alone with questions she doesn't dare ask. Silence doesn't protect anyone: it pushes girls away. It's exactly what happens with [the cycle and the coach](/en/blog/parlare-di-ciclo-con-allenatore), where only 11% of athletes raise the topic with the person coaching them.

## Which symptoms remove training sessions without appearing in any record?

**The ones that stop nobody.** Drop-out almost never arrives as a decision: it arrives as a sum of missed sessions, dialled-down intensity and changed movements that nobody writes down, because none of these symptoms prevents training. They are the gaps that appear in no injury log:

- [Period pain](/en/blog/dolori-mestruali-giovani-atlete), the most widespread form of recurrent pain among school-age girls: among athletes, dysmenorrhoea has a prevalence of 32.3% (Taim et al., 2023).
- [Urinary leakage during jumping](/en/blog/perdite-urina-giovani-atlete): mean prevalence of 48.58% among adolescent female athletes, and 87% would not mention it to their coach (Rial Rebullido et al., 2021).
- The wrong [sports bra](/en/blog/reggiseno-sportivo-ragazze), or none at all: at 13-14, 51% of girls say their breasts affect their participation in sport (Scurr et al., 2016).
- Overuse pain that does not swell and does not make anyone limp: [the shoulder in overhead sports](/en/blog/dolore-spalla-giovani-atlete), where 23% of athletes aged 15-18 have substantial problems in a single season (Asker et al., 2018); [low back pain](/en/blog/mal-di-schiena-giovani-atlete); [the ankle that keeps giving way](/en/blog/distorsione-caviglia-giovani-atlete) after a sprain filed away as «just a twist».
...
**By acting on the environment, not on the individual girl's motivation.** It is the same principle as [the practical guide for coaching adolescent girls](/en/blog/allenare-ragazze-adolescenti): none of the four levers below requires a doctor on site or a dedicated budget: they are culture, aggregated data, practical conditions and injury prevention. They are also, in that order, the ones with the best cost-to-return ratio for a club.

1. **Culture.** Normalise the topic with plain, non-judgemental language. This isn't rhetoric: in the Female Athlete Health Report 2023, athletes who perceived their coach as very well-informed reported on average 3.2 RED-S symptoms against 4.3, i.e. roughly **36% fewer** (Woolven et al., 2023 — a survey of 769 athletes with a mean age of 32, so an **adult sample**, and a **non-peer-reviewed** report: read it as an indication, not as an estimate for adolescents). [A coach's words](/en/blog/parole-allenatore-salute-atlete) are a health variable.
...
3. **Continuity and practical conditions.** Privacy in changing rooms, period products available, stable people to look up to. And watch what looks like a detail: the [sports bra](/en/blog/reggiseno-sportivo-ragazze) is one of the least-discussed reasons a girl quietly dials down her intensity — and [urinary leakage during jumping](/en/blog/perdite-urina-giovani-atlete) is discussed even less, affecting nearly one adolescent athlete in two, with 87% saying they would not raise it with their coach.
4. **Prevent the injury that ends everything.** A dropout can begin with one long lay-off. In high-school sport girls sustain 1.40 times the ACL injuries of their male peers (Bram et al., 2021), and twenty minutes of [neuromuscular training twice a week](/en/blog/crociato-giovani-atlete) cuts that risk by roughly 60% in the 13-19 band (Petushek et al., 2019). The same applies to the long lay-offs that make no noise: in high-school sport girls sustain [stress fractures](/en/blog/salute-ossea-fratture-da-stress-giovani-atlete) 1.75 times as often as their male peers, and one in five comes back (Changstrom et al., 2015). It is the best cost-to-return lever a club has.
...
BAB gives clubs the tools to read the team's aggregated, anonymous signals, and gives athletes the free app to listen to their own bodies. Two sides of the same goal: **don't let it happen.**

## Sources

- Women in Sport. **Reframing Sport for Teenage Girls: Tackling Teenage Disengagement.** 2022. (Savanta survey of 2,291 girls and 2,024 boys aged 11-18, UK — not peer-reviewed) [womeninsport.org](https://womeninsport.org/wp-content/uploads/2022/03/2022-Reframing-Sport-for-Teenage-Girls-Tackling-Teenage-Disengagement.pdf)
- Brenner J.S., Watson A., AAP Council on Sports Medicine and Fitness. **Overuse Injuries, Overtraining, and Burnout in Young Athletes.** *Pediatrics*, 2024;153(2):e2023065129. (American Academy of Pediatrics clinical report: burnout named as one of the primary reasons for attrition in youth sports; clinical guidance, not a primary study) [doi:10.1542/peds.2023-065129](https://doi.org/10.1542/peds.2023-065129)
- Gustafsson H., Kenttä G., Hassmén P., Lundqvist C. **Prevalence of Burnout in Competitive Adolescent Athletes.** *The Sport Psychologist*, 2007;21(1):21-37. (980 Swedish **adolescent** athletes — 402 female, 578 male — across 29 sports; 1-9% with elevated subscale scores; a **screening** instrument, not clinical diagnoses) [doi:10.1123/tsp.21.1.21](https://doi.org/10.1123/tsp.21.1.21)
- Woolven P., Seary K., Maclennan M., Langbein R., Bridge G. **The Female Athlete Health Report 2023.** Project RED-S / Kyniska Advocacy, UK, 2023. (survey of 769 athletes, mean age 32 — an **ADULT** sample; advocacy report, **not peer-reviewed**, i.e. grey literature: athletes who perceived their coach as very well-informed reported on average 3.2 RED-S symptoms against 4.3, roughly 36% fewer) [kyniskaadvocacy.com](https://www.kyniskaadvocacy.com/research/the-female-athlete-health-report-2023)
- Lima R., et al. **Age at Peak Height Velocity in Young Female Athletes: A Bayesian Longitudinal Meta-Analysis.** *Cureus*, 2024. (Bayesian meta-analysis of 14 studies and 21 independent samples of young female athletes; estimated mean age at peak height velocity 11.18 years, 90% credible interval 8.62-12.94) [doi:10.7759/cureus.59482](https://doi.org/10.7759/cureus.59482)
- Taim B.C., Ó Catháin C., Renard M., Elliott-Sale K.J., Madigan S., Ní Chéilleachair N. **The Prevalence of Menstrual Cycle Disorders and Menstrual Cycle-Related Symptoms in Female Athletes: A Systematic Literature Review.** *Sports Medicine*, 2023;53(10):1963-1984. (60 studies, 6,380 athletes not using hormonal contraception; dysmenorrhoea the most frequent disorder, prevalence 32.3%, range across studies 7.8-85.6%) [doi:10.1007/s40279-023-01871-8](https://doi.org/10.1007/s40279-023-01871-8)
- Asker M., Holm L.W., Källberg H., Waldén M., Skillgate E. **Female adolescent elite handball players are more susceptible to shoulder problems than their male counterparts.** *Knee Surgery, Sports Traumatology, Arthroscopy*, 2018;26(7):1892-1900. (471 players aged 15-18, 256 female; 23% with substantial shoulder problems in one season; females PR 1.46, 95% CI 1.04-2.06) [doi:10.1007/s00167-018-4857-y](https://doi.org/10.1007/s00167-018-4857-y)
