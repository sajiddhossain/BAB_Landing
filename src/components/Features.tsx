...
export default function Features() {
 ...
 <h1 
 className="font-['Bricolage_Grotesque',_sans-serif] text-5xl sm:text-7xl font-black leading-none uppercase drop-shadow-[4px_4px_0_rgba(15,15,18,1)] md:drop-shadow-[7px_7px_0_rgba(15,15,18,1)] text-[#34BBC0] tracking-tighter" style={{ WebkitTextStroke: '2.5px #0F0F12', paintOrder: 'stroke' }} dangerouslySetInnerHTML={{__html: t('features.title')}}
 />
 </div>
