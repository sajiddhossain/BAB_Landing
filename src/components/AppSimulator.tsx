...
function Done({ onOpenWaitlist, onReset, mood, bounce }: { onOpenWaitlist?: (t?: UserType) => void; onReset: () => void; mood: Mood; bounce: number }) {
 ...
 <div className="inline-block bg-[#FFC042] border-[3px] border-black px-4 py-1.5 font-black uppercase text-sm shadow-[3px_3px_0_0_#0F0F12] mb-2">Buddy al top! 🔥</div>
