  ...
  return (
    <section className="w-full max-w-6xl mx-auto px-4 sm:px-6 py-16 sm:py-20">
      <header className="mb-12 sm:mb-16">
        <span className="inline-block bg-[#EBE5FF] text-[#0F0F12] border-[3px] border-black px-4 py-1.5 font-black uppercase tracking-widest text-xs shadow-[4px_4px_0_0_#0F0F12] -rotate-1 mb-6">
          {t('blog.kicker')}
        </span>
