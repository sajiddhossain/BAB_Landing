...
export default function Home({ onOpenWaitlist }: HomeProps) {
 ...
 <h2 className="font-['Bricolage_Grotesque',_sans-serif] text-4xl sm:text-6xl lg:text-7xl font-black uppercase tracking-tighter text-[#34BBC0] drop-shadow-[3px_3px_0_rgba(15,15,18,1)] md:drop-shadow-[6px_6px_0_rgba(15,15,18,1)] mb-6 break-words max-w-full">
 {t('home.bivioTitle')}
 </h2>
