  ...
  return (
    <div className="flex flex-col items-center w-full min-h-screen text-[#0F0F12]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
          ...
          >
            ...
            >
              ...
              <svg className="hidden lg:block absolute right-0 -bottom-8 w-16 h-16 text-black rotate-12 opacity-70" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            {/* IMMAGINE MOBILE (Nascosta su Desktop) - Subito sotto il titolo */}
            <motion.div 
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4 }}
              className="w-full max-w-lg mb-6 bg-white border-[3px] border-black shadow-[6px_6px_0_0_#0F0F12] p-1 flex flex-col sm:flex-row gap-2 sm:gap-0"
            >
               <button 
          ...
          <motion.div 
            ...
            className="lg:col-span-5 w-full justify-center hidden lg:flex relative"
          >
            <div className="w-full max-w-md bg-white border-[4px] border-white p-2 shadow-[12px_12px_0_0_#0F0F12] rotate-3 hover:rotate-1 transition-transform duration-500 relative group">
              ...
              <motion.div 
                ...
                className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-[#DAE69A] border-[3px] border-black p-3 shadow-[6px_6px_0_0_#000] -rotate-3 z-20 hidden sm:flex items-center gap-3 group-hover:-translate-y-2 group-hover:rotate-0 transition-all duration-300"
              >
      ...
      <section className="w-full max-w-5xl px-4 py-16 mx-auto mb-16 relative">
        ...
        <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 w-full relative z-10">
          {/* Vecchio Metodo */}
          <div 
            onClick={() => setBivioState('vecchio')}
            className={`flex-1 p-8 sm:p-10 border-[4px] border-black transition-all cursor-pointer relative ${bivioState === 'vecchio' ? 'bg-[#FFE3D1] shadow-[8px_8px_0_0_#000] rotate-0 scale-100 z-10' : 'bg-white/80 backdrop-blur-sm shadow-[4px_4px_0_0_#000] -rotate-2 scale-95 opacity-70 hover:opacity-100 hover:rotate-0'}`}
          >
          ...
          <div 
            ...
            className={`flex-1 p-8 sm:p-10 border-[4px] border-black transition-all duration-500 cursor-pointer flex flex-col justify-between relative ${bivioState === 'bab' ? 'bg-[#DAE69A] shadow-[8px_8px_0_0_#000] rotate-1 scale-100 z-10' : 'bg-white/80 backdrop-blur-sm shadow-[4px_4px_0_0_#000] rotate-3 scale-95 opacity-70 hover:opacity-100 hover:scale-[0.98] hover:rotate-1'}`}
          >
      ...
      <section className="w-full bg-[#EBE5FF] border-y-[4px] border-black py-20 px-4 my-16 relative overflow-hidden">
        <div className="max-w-5xl mx-auto relative z-10 flex flex-col md:flex-row gap-12 items-center">
          ...
          <div className="w-full md:w-1/3 shrink-0 hidden md:block">
            <img 
              ...
              alt="Atleta BAB" 
              className="w-full aspect-square object-cover border-[4px] border-black shadow-[8px_8px_0_0_#000] rotate-3 grayscale hover:grayscale-0 transition-all duration-300" 
            />
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto mt-12 relative z-10">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 relative">
            ...
            <svg className="absolute top-1/2 left-0 w-full h-8 -translate-y-1/2 text-black opacity-30 -z-10 hidden sm:block" viewBox="0 0 100 20" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 masonry-like">
            {testimonials.map((t, i) => (
               <div key={i} className={`${t.color} text-black border-[4px] border-white p-8 sm:p-10 hover:-translate-y-2 transition-transform ${i % 2 !== 0 ? 'md:mt-16' : ''}`}>
