    ...
    <div className="flex flex-col items-center w-full min-h-screen">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center w-full">
          ...
          >
            ...
            <motion.div 
              ...
              className="inline-block px-3 py-1 bg-[#EBE5FF] border-[2px] md:border-[3px] border-black text-black font-black text-[10px] sm:text-xs tracking-widest uppercase mb-4 sm:mb-6 shadow-[4px_4px_0_0_#DAE993] -rotate-1"
            >
              {t('home.badge')}
            </motion.div>
            ...
            <motion.h1 
              ...
              className="font-['Bricolage_Grotesque',_sans-serif] text-4xl md:text-5xl lg:text-6xl font-black leading-[1.1] mb-6 tracking-tight w-full relative text-[#DAE993]"
            >
              {t('home.heroTitle')}<br/>
              <span className="inline-block relative z-10 mt-3 px-4 sm:px-6 py-2 -rotate-2 bg-[#34BBC0] border-[3px] md:border-[4px] border-black shadow-[4px_4px_0_0_#DAE993] md:shadow-[6px_6px_0_0_#DAE993] text-white">
                 {t('home.heroHighlight')}
              </span>
              
              {/* Hand-drawn Doodle Arrow (Desktop) */}
              <svg className="hidden lg:block absolute right-0 -bottom-8 w-16 h-16 text-[#DAE993] rotate-12 opacity-70" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            >
              <div className="w-full max-w-[280px] sm:max-w-[320px] bg-white border-[4px] border-white p-2 shadow-[8px_8px_0_0_#34BBC0] rotate-2 relative">
            ...
            <motion.div 
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4 }}
              className="w-full max-w-lg mb-6 bg-[#FAF9F6] border-[3px] border-black shadow-[6px_6px_0_0_#34BBC0] p-1 flex flex-col sm:flex-row gap-2 sm:gap-0 text-[#0F0F12]"
            >
               <button 
            ...
            >
               <p className="text-sm sm:text-base md:text-lg font-bold border-l-[4px] border-[#DAE993] pl-4 text-left leading-snug">
            ...
            >
              <button 
                ...
                className="w-full sm:w-auto font-['Space_Grotesk',_sans-serif] font-black text-lg bg-[#FFDE4D] border-[3px] md:border-[4px] border-black px-6 md:px-8 py-3 md:py-4 shadow-[6px_6px_0_0_#DAE993] hover:shadow-[2px_2px_0_0_#DAE993] hover:translate-y-1 transition-all duration-300 uppercase relative group overflow-hidden"
              >
              ...
              <div 
                className="font-['Space_Grotesk',_sans-serif] font-black text-[10px] sm:text-xs bg-[#EBE5FF] border-[2px] md:border-[3px] border-black px-3 md:px-4 py-2 shadow-[4px_4px_0_0_#DAE993] -rotate-1 cursor-default text-center"
          ...
          >
            <div className="w-full max-w-md bg-white border-[4px] border-white p-2 shadow-[12px_12px_0_0_#34BBC0] rotate-3 hover:rotate-1 transition-transform duration-500 relative group">
              ...
              <motion.div 
                ...
                className="absolute -bottom-4 -left-4 sm:-bottom-6 sm:-left-6 bg-[#DAE69A] border-[3px] border-black p-3 shadow-[6px_6px_0_0_#34BBC0] -rotate-3 z-20 hidden sm:flex items-center gap-3 group-hover:-translate-y-2 group-hover:rotate-0 transition-all duration-300"
              >
      ...
      <section className="w-full max-w-5xl px-4 py-16 mx-auto mb-16 relative">
        <h2 className="font-['Bricolage_Grotesque',_sans-serif] text-4xl sm:text-5xl lg:text-6xl font-black text-center uppercase mb-16 relative z-10">
          <span className="bg-white border-[3px] border-black px-6 py-2 shadow-[6px_6px_0_0_#34BBC0] inline-block -rotate-1 text-[#0F0F12]">{t('home.costBadge')}</span>
        </h2>
        
        {/* Doodle connector between cards */}
        <svg className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-32 h-32 text-white opacity-20 z-0 hidden sm:block" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="flex flex-col sm:flex-row gap-8 sm:gap-12 w-full relative z-10 text-[#0F0F12]">
          ...
          <div 
            ...
            className={`flex-1 p-8 sm:p-10 border-[4px] border-black transition-all cursor-pointer relative ${bivioState === 'vecchio' ? 'bg-[#FFE3D1] shadow-[8px_8px_0_0_#34BBC0] rotate-0 scale-100 z-10' : 'bg-white/90 backdrop-blur-sm shadow-[4px_4px_0_0_#34BBC0] -rotate-2 scale-95 opacity-80 hover:opacity-100 hover:rotate-0'}`}
          >
          ...
          <div 
            ...
            className={`flex-1 p-8 sm:p-10 border-[4px] border-black transition-all duration-500 cursor-pointer flex flex-col justify-between relative ${bivioState === 'bab' ? 'bg-[#DAE69A] shadow-[8px_8px_0_0_#DAE993] rotate-1 scale-100 z-10' : 'bg-white/90 backdrop-blur-sm shadow-[4px_4px_0_0_#DAE993] rotate-3 scale-95 opacity-80 hover:opacity-100 hover:scale-[0.98] hover:rotate-1'}`}
          >
      ...
      <section className="w-full py-20 px-4 my-16 relative overflow-hidden">
        <div className="max-w-5xl mx-auto relative z-10 flex flex-col md:flex-row gap-12 items-center">
          <div className="flex-1">
            <div className="inline-block bg-[#34BBC0] text-white border-[3px] border-black px-4 py-2 font-black uppercase tracking-widest text-sm shadow-[4px_4px_0_0_#DAE993] mb-8">
              {t('home.dataBadge')}
            </div>
            <h2 
              className="font-['Bricolage_Grotesque',_sans-serif] text-[#DAE993] text-4xl sm:text-6xl font-black leading-tight uppercase mb-6"
              dangerouslySetInnerHTML={{__html: t('home.dataTitle')}}
            />
            <p className="text-xl font-bold mb-8 max-w-3xl text-[#F7F7F7]">{t('home.dataSubtitle')}</p>
          </div>
          ...
          <div className="w-full md:w-1/3 shrink-0 hidden md:block">
            <img 
              ...
              alt="Atleta BAB" 
              className="w-full aspect-square object-cover border-[4px] border-black shadow-[8px_8px_0_0_#34BBC0] rotate-3 grayscale hover:grayscale-0 transition-all duration-300" 
            />
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto mt-12 relative z-10 text-[#0F0F12]">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 sm:gap-6 relative">
            ...
            <svg className="absolute top-1/2 left-0 w-full h-8 -translate-y-1/2 text-white opacity-20 -z-10 hidden sm:block" viewBox="0 0 100 20" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="bg-[#FAF9F6] border-[4px] border-black p-8 shadow-[6px_6px_0_0_#DAE993] rotate-1 relative">
            ...
            <div className="bg-[#FAF9F6] border-[4px] border-black p-8 shadow-[6px_6px_0_0_#34BBC0] -rotate-2 relative">
            ...
            <div className="bg-[#FAF9F6] border-[4px] border-black p-8 shadow-[6px_6px_0_0_#DAE993] rotate-2 relative">
      ...
      <section className="w-full py-24 px-4">
        <div className="max-w-6xl mx-auto">
          <h2 className="font-['Bricolage_Grotesque',_sans-serif] text-[#DAE993] text-4xl sm:text-6xl font-black uppercase mb-16 text-center max-w-4xl mx-auto leading-tight">
            {t('home.testimonialsTitle')}
          </h2>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 masonry-like">
            {testimonials.map((t, i) => (
               <div key={i} className={`${t.color} text-[#0F0F12] border-[4px] border-black shadow-[8px_8px_0_0_#34BBC0] p-8 sm:p-10 hover:-translate-y-2 transition-transform ${i % 2 !== 0 ? 'md:mt-16' : ''}`}>
      ...
      {/* 6. FOOTER / MANIFESTO */}
      <section className="w-full max-w-4xl mx-auto px-4 py-24 text-center relative">
        
        {/* Doodle abstract bg for the footer title */}
        <svg className="absolute top-0 left-1/2 -translate-x-1/2 w-[150%] h-64 opacity-10 -z-10 pointer-events-none" viewBox="0 0 200 100" xmlns="http://www.w3.org/2000/svg">
          <path fill="#FFDE4D" d="M10 50 Q 50 0 150 50 T 190 50 Q 100 100 10 50 Z" />
        </svg>

        <div className="mb-16">
          <h2 
            className="font-['Bricolage_Grotesque',_sans-serif] text-4xl sm:text-6xl font-black uppercase leading-tight mb-4 text-[#DAE993]" 
            dangerouslySetInnerHTML={{__html: t('home.footerTitle')}}
          />
        </div>

        <div className="bg-[#FAF9F6] text-[#0F0F12] border-[4px] border-black p-8 sm:p-12 text-left shadow-[8px_8px_0_0_#34BBC0] rotate-1 relative max-w-3xl mx-auto">
        ...
        <div className="mt-20 border-t-[3px] border-white/20 pt-12 border-dashed flex flex-col items-center gap-6 relative text-center">
          <img src="/BAB_logo.svg" alt="BAB Logo" className="h-10 md:h-12 mb-2 invert" />
          <p className="font-['Bricolage_Grotesque',_sans-serif] text-xl font-black max-w-lg mb-2 text-[#DAE993]">
             {t('home.motto')}
          </p>
          <div className="flex gap-6 font-bold uppercase tracking-widest text-sm mb-4">
             <a href="https://substack.com/@babcommunity" target="_blank" rel="noopener noreferrer" className="hover:text-[#DAE993] transition-colors underline decoration-2 underline-offset-4">Substack</a>
             <a href="https://www.instagram.com/bab_community/" target="_blank" rel="noopener noreferrer" className="hover:text-[#DAE993] transition-colors underline decoration-2 underline-offset-4">Instagram</a>
          </div>
          <div className="font-black uppercase tracking-widest text-xs text-white/50">
